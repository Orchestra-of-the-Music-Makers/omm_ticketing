...
var $author$project$Main$init = F3(
	function (flags, urlUrl, keyNavigationBrowser) {
		return _Utils_Tuple2(
			{},
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Main$Abc = {$: 'Abc'};
var $author$project$Main$onUrlChange = function (urlUrl) {
	return $author$project$Main$Abc;
};
var $author$project$Main$onUrlRequest = function (urlRequestBrowser) {
	return $author$project$Main$Abc;
};
